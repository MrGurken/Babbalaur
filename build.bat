...
cl.exe -nologo -Zi -EHsc -Febabbalaur.exe ..\code\Babbalaur\win_main.cpp /IC:\GLEW\include /IC:\SDL2\SDL\include /IC:\SDL2\Image\include /IC:\GLM\ /IC:\GLM\detail /IC:\GLM\gtc /IC:\GLM\gtx /MD /link /INCREMENTAL:NO /SUBSYSTEM:CONSOLE /LIBPATH:C:\GLEW\lib\Release\Win32\ /LIBPATH:C:\SDL2\SDL\lib\ /LIBPATH:C:\SDL2\Image\lib\x86\ SDL2.lib SDL2main.lib SDL2_image.lib opengl32.lib glew32.lib
